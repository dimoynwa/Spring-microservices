...
import io.dimo.user.exception.ErrorResource;
...
public class GlobalErrorHandler implements ErrorWebExceptionHandler {
    ...
    public Mono<Void> handle(ServerWebExchange exchange, Throwable ex) {
        ...
        if (ex instanceof UserNotFoundException userNotFound) {
            status = HttpStatus.NOT_FOUND;
            error = new ErrorResource("USER_NOT_FOUND", "User with that id cannot be found");
